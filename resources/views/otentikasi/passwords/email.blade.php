            ...
            <div class="card shadow-lg forgot-box">
                <div class="card-body p-md-5">
                    <div class="text-center">
                        <img src="{{asset('assets/template_admin')}}/assets/images/icons/forgot-2.png" width="140"
                            alt="" />
                    </div>
                    <form action="{{ route('password.email') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg btn-block radius-30">Send</button> <a
                            href="{{ url('') }}" class="btn btn-link btn-block"><i
