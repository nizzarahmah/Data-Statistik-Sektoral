...
@section('title','Tambah Pemerintahan Daerah Pengampu')
@section('content')
<!--Data Tables -->
...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
            <div class="breadcrumb-title pr-3">Tambah Pemerintahan Daerah Pengampu</div>
            <div class="pl-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ url()->previous()}}"><i class='bx bx-home-alt'></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Tambah Pemerintahan Daerah Pengampu</li>
                    </ol>
                </nav>
            </div>
            <div class="ml-auto">
            ...
            <div class="col-12 col-lg-12">
                <div class="card radius-15">
                    <div class="card-body">
                        ...
                        <hr />
                        <form action="{{ route('pemerintahan_daerah_pengampu.store') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="">Nama OPD</label>
                                <input type="text" name="nama_opd"
                                    class="form-control @error('nama_opd') is-invalid @enderror" placeholder="Nama OPD">
                                @error('nama_opd')
